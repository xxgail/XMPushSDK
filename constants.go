...
const (
	...
	ExtraPrefix           = "extra."
	ApsProperFieldsPrefix = "aps_proper_fields."

	HybridPushAction    = "push_server_action"
	HybridActionMessage = "hybrid_message"
	HybridDebug         = "hybrid_debug"
	HybridPath          = "hybrid_pn"

	NotifyForeground = "notify_foreground"
	NotifyEffect     = "notify_effect"
	InstantNotify    = "instant_notify"
)
